...
public class OrthogonalTiledMapRenderer2 extends com.khoa.demo1.BatchTiledMapRenderer {
    ...
    public OrthogonalTiledMapRenderer2(TiledMap map, int x) {
        super(map);
        this.displacement = x;
    }

    public OrthogonalTiledMapRenderer2(TiledMap map, SpriteBatch spriteBatch) {
    ...
    public OrthogonalTiledMapRenderer2(TiledMap map, float unitScale, SpriteBatch spriteBatch) {
    ...
    public void Render(MapLayers map){
    ...
    public void renderTileLayer (TiledMapTileLayer layer, int xDisplacement) {
        ...
        final int col2 = Math.min(layerWidth + xDisplacement, (int) ((viewBounds.x + viewBounds.width + layerTileWidth) / layerTileWidth));
